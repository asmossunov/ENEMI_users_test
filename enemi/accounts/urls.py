...
from accounts.views.accounts import AccountCreateView, AccountTutorCreateView, AccountStudyCenterCreateView, \
    TutorCreateView, StudyCenterCreateView
...
urlpatterns = [
    ...
    path('register/student', AccountCreateView.as_view(), name='account_register'),
